...
async def health() -> HealthResponse:
    ...
    return HealthResponse(
        ...
        env=settings.app_env.value, live_trading_enabled=settings.live_trading_enabled,
        live_allowed=settings.is_live_allowed(), timestamp=datetime.now(timezone.utc).isoformat(),
    )
